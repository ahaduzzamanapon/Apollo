...
<div class="container-fluid">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0 text-gray-800 fw-bold">Create TestField</h5>
        ...
        <div class="card-body p-4">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('perameter') is-invalid @enderror" id="perameter" name="perameter" value="{{ old('perameter') }}">
                @error('perameter')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('ref_val') is-invalid @enderror" id="ref_val" name="ref_val" value="{{ old('ref_val') }}">
                @error('ref_val')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
                ...
                <div class="mt-4 d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save me-1"></i> Save TestField
                    </button>
                </div>
            </form>
        </div>
