...
class MenuSeeder extends Seeder
{
    public function run()
    {
        ...
        $menus = [
            ...
            // 6. Accounts (Order 6) - [Shifted]
            ['id' => 16, 'title' => 'Accounts', 'route' => NULL, 'icon' => 'bi-wallet', 'parent_id' => NULL, 'order' => 6, 'created_at' => NULL, 'updated_at' => '2025-12-16 10:40:21'],
            ...
            ['id' => 22, 'title' => 'Accounts Report', 'route' => 'accounts.report', 'icon' => NULL, 'parent_id' => 16, 'order' => 3, 'created_at' => NULL, 'updated_at' => NULL],
            
            // 7. Bank Management (Order 7) - [NEW PARENT]
            ['id' => 21, 'title' => 'Bank Management', 'route' => 'banks.index', 'icon' => 'bi bi-bank', 'parent_id' => NULL, 'order' => 7, 'created_at' => NULL, 'updated_at' => NULL],

            // 8. User Management (Order 8) - [Shifted]
            ['id' => 2, 'title' => 'User Management', 'route' => 'admin.users.index', 'icon' => 'bi bi-people', 'parent_id' => NULL, 'order' => 8, 'created_at' => '2025-12-16 10:27:18', 'updated_at' => '2025-12-16 10:40:21'],

            // 9. Roles & Permissions (Order 9) - [Shifted]
            ['id' => 3, 'title' => 'Roles & Permissions', 'route' => NULL, 'icon' => 'bi bi-shield-lock', 'parent_id' => NULL, 'order' => 9, 'created_at' => '2025-12-16 10:27:18', 'updated_at' => '2025-12-16 10:40:21'],
            ...
            // 10. Configurations (Order 10) - [Shifted]
            ['id' => 6, 'title' => 'Configurations', 'route' => NULL, 'icon' => 'fa-solid fa-house-flag', 'parent_id' => NULL, 'order' => 10, 'created_at' => '2025-12-16 10:27:18', 'updated_at' => '2025-12-16 10:40:21'],
